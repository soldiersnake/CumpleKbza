...
const imagenes = [
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function cambiarImagen() {
        if (animating) return; // No hacer nada si ya hay una animación en curso
        animating = true;
        ...
        nuevaImagen.src = randomImage;
        nuevaImagen.classList.add('animar'); // Añadir clase para animación

        nuevaImagen.addEventListener('animationend', () => {
            carrusel.removeChild(nuevaImagen);
            animating = false; // Resetear el flag de animación
        });
